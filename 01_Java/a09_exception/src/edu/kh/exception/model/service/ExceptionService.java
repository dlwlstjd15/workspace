...
import edu.kh.exception.model.UserException;
...
public class ExceptionService {
	...
	public void ex1() {
		...
		//br. readLine()을 작성하면 빨간줄이 든다
		// 왜?
		// --> IOException에 대한 처리가 강제되고 있름
		// --> 이렇기 꼭 예외처리 하라는 예외들을 묶어

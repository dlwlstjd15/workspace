...
//			}
	...
	} // displayMenu() 끝  ctrl + shift + p : { } 시작/끝 지점 이동
...
//		double number = sc.nextDouble();
//		
//		double saveValue = calc.getSaveValue(); // 기존 결과
//		
...
//	//최소값으로 변경
//	
//	public double cangeMinValue() {
//		saveValue = MIN_VALUE;
//		return saveValue;
//	}
//	
//	//원의 넓이 구하기 :PI * 반지름의 제곱
//	public double thrAreaOFACircle(double r) {
//		saveValue = PI;
//		return saveValue;
//	}
//	

...
public class SwitchEx {
	...
	/* switch문
	 *  - 식 하나의 결과로 많은 경우의 수를 처리할 때 사요ㅇ하는 조건문
	 ...
	 *  ...
	 *  
	 *  default : 모든 case가 만족하지 못할 때 수헹할 코드
	 */
	...
	public void ex2() {
		...
		// Math.random() * 5 + 1 :  1.0 <= x * 5 < 6.0
		
		// (int)(Math.random() * 5 + 1) : 1 <= (int) (x * 5 + 1) < 6.0
	...
	// -두 정수와 1개의 연산자 (+_/%)를 입력 받아 연산 결과를 출력

...
public class VariableEx8 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 형변환이 왜 필요한가?
		 * -> 컴퓨터의 값 처리 원칙을 위배하는 경우를 해결하기 위해서
		 *  (같은 자료형가라 연산, 결과도 같은 자료형)
		 *
		 *  
		 *  */
		...
		// 강제 형변환 확인1 : 실수 -> 정수 (데이터 손실)
		double test1 = 3.14;
		
		
		// double  자료형을 int로 바꿀 수 없다
		
		int test2 = (int)test1; // int로 강제 형변화

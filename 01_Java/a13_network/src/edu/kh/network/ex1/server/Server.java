...
public class Server {
	...
	public void start() {
		...
		// 1023번 이하는 0s에서 사용하는 경우가 많으므로 사용 권장x
		...
		try {
		    ...
		    String massage = sdf.format(now) + "[서버 접속 성공]";
		    
		    pw.println(massage); // 서버 -> 클라이언트로 메세지 출력
		    ...
		    System.out.println(clientIP + "클라이언트로 부터 받은 메세지 : " + clientMessage);

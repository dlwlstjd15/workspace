...
//		menuArray[4] = "닭갈비";
		...
		,"샐러드","닭갈비", "순대국밥", "평양냉면" ,"삼김+라면", "도시락","육회비빔밥"};
	...
	public void ex7() {
		...
		while(true) { // 무한반복
			...
			System.out.println("저장된 값을 확인하려는 인덱스(-1 종료) : ");
	...
	public void ex9() {
		...
		System.arraycopy(arr,0,copyArr2,0,arr.length); // 5칸
